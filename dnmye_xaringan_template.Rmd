---
title: "SINTA"
subtitle: "Sistema de Información Turística de la Argentina"  
author: 
  - "Dirección Nacional de Mercados y Estadística"
  - "Subsecretaría de Desarrollo Estrátegico"
date: '`r Sys.Date()`'
output:
...
xaringanExtra::use_progress_bar(color = comunicacion::dnmye_colores("amarillo"))
